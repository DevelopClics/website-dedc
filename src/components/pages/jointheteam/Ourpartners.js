...
const Ourpartners = () => {
  ...
  return (
    <>
      <div className="pt-5" id="join-ourpartners"></div>
      <div className="container pt-5 rounded-1">
        <div className="text-middle text-light">
          <h1>
            <span className="Titre2 px-2">Nos partenaires</span>{" "}
          </h1>
        </div>
        ...
        >
          <h4 className="pt-4 text-light text-uppercase text-start">
            <span className="Titre2 px-2">Institutionnels</span>
          </h4>
          ...
          <h4 className="pt-4 text-light text-uppercase text-start">
            <span className="Titre2 px-2">Clients</span>
          </h4>
          <h5 className="pt-2 Texte1 text-start">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
          ...
          <h4 className="pt-4 text-light text-uppercase text-start">
            <span className="Titre2 px-2">Clubs</span>
          </h4>
          <h5 className="pt-2 Texte1 text-start">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
